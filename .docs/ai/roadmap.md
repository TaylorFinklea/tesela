...
> - [ ] **Daily-driver views** (next plan): daily journal, page/outliner (reuse CodeMirror BlockOutliner), inbox, agenda, search — fill the pane/tab bodies. → **cutover** (delete old; switch entries) → **iterate**.
