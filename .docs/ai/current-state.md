...
- [ ] **Next Lead:** **L1 sync** (min key/pairing + cursor migration, HA-first — big, design = Taylor's call; the last major open item). Fleet backlog now largely cleared (slash-registry + ED1 done).
