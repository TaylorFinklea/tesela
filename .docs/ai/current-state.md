...
- [ ] P2 engine hydration/materialization/cold-reload/two-engine convergence + fence-safe indexing/classification (TDD) · tier_floor: senior · complexity: M. Verify: `cargo test -p tesela-sync -p tesela-core`
