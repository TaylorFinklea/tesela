...
- Desktop restore (2026-06-27 eve): RESOLVED — Taylor Cmd+Q'd + reopened /Applications (my `target/` relaunch had left 7474 dead). LESSON: never launch the desktop from `target/`; build → Taylor installs to /Applications → relaunch.
