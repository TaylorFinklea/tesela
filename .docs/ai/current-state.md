...
- C3 (#185, iOS↔web same-block wire-verify + remove DIAG) NOT built — web↔web done; remaining = iOS↔web on device/sim + C1-inbound (#183, iOS live-apply remote splices into the UITextView) + strip DIAG.
