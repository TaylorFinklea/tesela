...
## Branch
- `main` @ `c6c9ee44` == origin/main — **PUSHED 2026-06-18** (everything below). Clean tree; `.docs/ai/review/` is untracked (the 3 open-source arch-review reports, kept for reference).
...
- [ ] **#64 mobile command palette** — toolbar button → searchable command registry (the `:`/leader stand-in). Needs the registry surfaced to iOS.
- [ ] **#65 capture sheet footer clipped behind keyboard** (intermittent).
