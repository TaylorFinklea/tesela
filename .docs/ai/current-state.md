...
- [ ] Task 7: ordered local-edit barrier plus pointer/keyboard UI. Verify: `cargo test -p tesela-server routes::ws::tests && pnpm --dir web check && pnpm --dir web test:unit`
