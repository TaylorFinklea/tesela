<script lang="ts">
  ...
  const leaderTree: ChordNode[] = [
    { key: "f", label: "File", children: [
      { key: "n", label: "New note",          action: triggerCmdK,                       vimChord: "⌘K" },
    ...
    { key: "b", label: "Block", children: [
      { key: "d", label: "Drill in",                  action: () => emitBlock("drillIn"),     vimChord: "⏎" },
      { key: "f", label: "Fold/unfold",               action: () => emitBlock("foldToggle"),  vimChord: "za" },
      { key: "p", label: "Toggle props",              action: () => emitBlock("propsToggle"), vimChord: "gp" },
      { key: "s", label: "Cycle status (+ Task tag)", action: () => emitBlock("statusCycle"), vimChord: "⌘⏎" },
      { key: "D", label: "Delete block",              action: () => emitBlock("delete"),      vimChord: "dd" },
      { key: "y", label: "Yank block",                action: () => emitBlock("yank"),        vimChord: "yy" },
    ]},
    ...
    { key: "s", label: "Search", children: [
      { key: "s", label: "Search palette",    action: triggerCmdK,                       vimChord: "⌘K" },
    ]},
    ...
    { key: "w", label: "Window", children: [
      { key: "h", label: "Left pane",         action: () => { setVSplitActiveSide("left"); setActiveRegion("focus"); }, vimChord: "⌃w h" },
      { key: "l", label: "Right pane",        action: () => { setVSplitActiveSide("right"); setActiveRegion("focus"); }, vimChord: "⌃w l" },
      { key: "j", label: "Drawer",            action: () => { setBottomDrawerOpen(true); setActiveRegion("bottom"); },   vimChord: "⌃w j" },
      { key: "k", label: "Focus",             action: () => setActiveRegion("focus"),                                    vimChord: "⌃w k" },
      { key: "q", label: "Close split",       action: () => goBackColumn(),                                              vimChord: "⌃w q" },
    ]},
    { key: "T", label: "Toggle drawer",       action: toggleBottomDrawer, vimChord: "b" },
